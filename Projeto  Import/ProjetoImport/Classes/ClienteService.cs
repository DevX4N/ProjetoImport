...
namespace ProjetoImport
{
    public class ClienteService
    {
        ...
        private DataGridView _gridCliente;

        public ClienteService(string conexao, DataGridView gridCliente)
        {
            _conexao = conexao;
            _gridCliente = gridCliente;
        }
        ...
        {
            _gridCliente.Invoke((MethodInvoker)delegate
            {
                _gridCliente.DataSource = dataTable;
            });
        }
        ...
        public void ExportarParaXls(DataSet dataset, string nomeArquivo)
        {
            try
            {
                using (var workbook = new XLWorkbook())
                {
                    ...
                    // Obtém a tabela TCLIENTE do DataSet
                    var dataTable = dataset.Tables["TCLIENTE"];
